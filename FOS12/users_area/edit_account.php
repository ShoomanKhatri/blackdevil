...
if (isset($_POST['user_update'])) {
    ...
    // check if new image has been selected.
    if ($_FILES['user_image']['error'] === 0) {
        ...
        // Update query.
        $update_data = "update `user_table` set user_name='$username', user_email='$user_email',user_image='$user_image',
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="text-center">
        ...
        <div class="form-outline mb-4 d-flex w-50 m-auto">
            ...
            <img src="./user_images/<?php echo $user_image; ?>" alt="" class="edit_image" name="edit_image">
        </div>
        <div class="form-outline mb-4">
