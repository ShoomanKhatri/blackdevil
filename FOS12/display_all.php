      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link hov" href="cart.php"><i class="fa-solid fa-cart-shopping"></i><sup> <?php cart_item(); ?></sup></a>
            </li>
            <li class="nav-item">
              <a class="nav-link hov" href="#">Total Price:<?php total_cart_price(); ?>/-</a>
            </li>
      ...
      <ul class="navbar-nav me-auto">
        ...
        if(!isset($_SESSION['username'])){
          ...
          if(!isset($_SESSION['username'])){
            ...
            echo "<li class='nav-item'>
            <a class='nav-link log' href='./users_area/logout.php'> Logout</a>
          </li>";
