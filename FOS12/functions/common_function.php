...
function search_product()
{
  ...
  if (isset($_GET['search_data_product'])) {
    ...
    $num_of_rows = mysqli_num_rows($result_query);
    if ($num_of_rows == 0) {
      echo "<h2 class='text-center text-danger'>No results match. No products found on this
      category!</h2>";
    }
    while ($row = mysqli_fetch_assoc($result_query)) {
      $product_id = $row['product_id'];
...
function view_details()
{
  ...
  if (isset($_GET['product_id'])) {
    ...
    <div class='col-md-8'>
          ...
          <div class='row'>
            <div class='col-md-12'>
              <h4 class='text-center text-info mb-5'>Related items</h4>
            </div>
            <div class='col-md-6'>
      ...
      if (!isset($_GET['my_orders'])) {
        if (!isset($_GET['delete_account'])) { 
          ...
          if ($row_count > 0) {
            ...
            <p class='text-center'><a href='profile.php?my_orders' class=' text-success fw-bold'>Order Details</a></p>";
          }else{
