...
<body>
    ...
    if (isset($_POST['edit_product'])) {
        ...
        echo $product_category;
         ...
         // fetching category_id.
        //  $select_category_update = "select * from `categories` where category_title='$product_category';";
        //  $result_category_update = mysqli_query($con, $select_category_update);
        //  $row_category_update = mysqli_fetch_assoc($result_category_update);
        //  $category_id = $row_category_update['category_id'];
        //  echo $category_id;
        ...
        // echo $product_brands;
        // fetching brand_id.
        // $select_brand_update = "select * from `brands` where brand_title='$product_brands';";
        // $result_brand_update = mysqli_query($con, $select_brand_update);
        // $row_brand_update = mysqli_fetch_assoc($result_brand_update);
        // $brand_id = $row_brand_update['brand_id'];

        // Check if all three images are selected
        $image1_selected = $_FILES['product_image1']['error'] === 0; //if true image is selected.
        $image2_selected = $_FILES['product_image2']['error'] === 0;
        $image3_selected = $_FILES['product_image3']['error'] === 0;

        if ($image1_selected && $image2_selected && $image3_selected) {
            ...
            //     or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '' or
            //     $product_price == ''
            // ) {
            ...
            $update_products = "update `products` set product_title='$product_title',product_description='$product_desc',
